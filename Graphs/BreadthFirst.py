...
print([x.value for x in BreadthWiseSearch(graph, graph.vertices[9], graph.vertices[2])])
print([x.value for x in BreadthWiseSearch(graph, graph.vertices[2], graph.vertices[7])])
print([x.value for x in BreadthWiseSearch(graph, graph.vertices[1], graph.vertices[10])])